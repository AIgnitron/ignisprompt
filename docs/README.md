...
- [Local Preview v0.1.2 Patch Release Draft](releases/v0.1.2-local-preview.md): draft patch package for post-v0.1.1 MCP compatibility and docs guardrail cleanup. This is not tagged or published.
