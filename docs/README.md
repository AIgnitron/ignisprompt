...
Latest local preview release: `v0.1.8-local-preview`.
...
- [Local Preview v0.1.7 Release](releases/v0.1.7-local-preview.md): published local-preview release record for the post-v0.1.6 local policy workbench arc, including `policy-scenarios`, policy packages, Aethra Local Policy Workbench, policy-check, demo workflow alignment, and conservative package validation hardening.
- [Local Preview v0.1.8 Release](releases/v0.1.8-local-preview.md): published local-preview release record for the Local Demo Studio arc, including `demo-summary`, demo packages, Aethra Local Demo Studio, demo-check, preview-release-check, and shared package/path validation hardening.
