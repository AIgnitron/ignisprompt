...
- Latest known main commit: `a7a6ca7 docs: prepare v0.1.1 local preview release package (#139)`
...
- The v0.1.1 local preview release-readiness package is documented in `docs/releases/v0.1.1-local-preview.md`. It is docs-only, not tagged or published, includes the GitHub release body draft, and summarizes post-v0.1.0 local preview hardening through #139.
