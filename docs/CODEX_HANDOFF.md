...
- Latest known main commit: `503b162 feat: add MCP local observability tools (#138)`
...
- The v0.1.1 local preview release package draft is documented in `docs/releases/v0.1.1-local-preview.md`. It is docs-only, not tagged or published, and summarizes post-v0.1.0 local preview hardening through #138.
...
- `docs/releases/v0.1.1-local-preview.md` is a draft release package only. It does not tag, publish, or claim production readiness. It should be reviewed with `docs/LOCAL_PREVIEW_RELEASE_CHECKLIST.md` before any future tag work.
