...
- Latest known main commit: `a0ab93b feat: add local readiness package workflow (#173)`
...
- The v0.1.5 local preview release-readiness draft is now being prepared in `docs/releases/v0.1.5-local-preview.md`. `v0.1.4-local-preview` remains the latest published release until v0.1.5 is explicitly tagged and published.
...
- `docs/releases/v0.1.5-local-preview.md` is the draft v0.1.5 release-readiness record for the local readiness arc. It is release prep only; do not tag or publish v0.1.5 until final verification and explicit release approval.
...
8. Finish v0.1.5 release-prep review, then only tag or publish after explicit release approval.
