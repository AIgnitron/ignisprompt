...
- Latest known main commit: `eef812e feat: add local operator package workflow (#177)`
...
- `v0.1.5-local-preview` is published and is the latest local preview release. It includes the post-v0.1.4 local readiness dashboard, quality gate, report export, diagnostics, package workflow, and release-readiness docs.
...
- v0.1.6 release-prep work is docs/checklist only. `docs/releases/v0.1.6-local-preview.md` prepares the local operator workflow release note while `v0.1.5-local-preview` remains the latest published release. Do not tag or publish `v0.1.6-local-preview` yet.
...
- `docs/releases/v0.1.6-local-preview.md` is the draft v0.1.6 release-readiness record for the local operator workflow arc. It is release-prep documentation only; `v0.1.5-local-preview` remains the latest published release until a future tag and release are explicitly requested.
