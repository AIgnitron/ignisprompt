...
- v0.1.5 planning: keep Aethra local readiness, `ignispromptctl readiness`, copy-safe readiness reports, command guidance, evidence workflow, and boundary-language checks conservative and fixture-backed by default.
