...
export const requiredDemoBoundaryTerms = [
  ...
  "read-only by default; guarded runner lifecycle requests require live-local Operator Mode and daemon acceptance",
...
export const demoStorySteps: DemoStoryStep[] = [
  ...
  },
  {
    ...
    summary: "Show capability and connector-style status hints plus guarded live-local runner lifecycle requests.",
    ...
    boundaryNote: "No model mutation controls and no automatic runner lifecycle requests.",
  },
  {
